...
| 3 | `ide-grade` | post-mvp | F-011, F-014, F-015, F-030, F-031, F-032 | Built-in LSP, tree-sitter highlighting, PTY terminal buffer. The editor becomes genuinely useful for daily development. |
